...
object ScalacOptions {
  ...
  private val removeConsoleIncompatibleOptions = scalacOptions in (Compile, console) --= Seq("-Ywarn-unused:imports",
                                                                                             "-Xfatal-warnings")

  val settings = Seq(desiredScalacOptions, removeInlineWarnings, removeConsoleIncompatibleOptions)
}
